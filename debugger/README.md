...
8) stack : inspection de la pile matérielle, et de la pile pointée par R31
...
9) status (peut-être changer les noms des watchpoints etc pour être consistant 
	avec gdb ?)
